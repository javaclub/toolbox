 ...
 * @version $Id: GUIDGenerator.java 56 2011-06-27 02:11:24Z gerald.chen.hz@gmail.com $
 */
public class GUIDGenerator implements IdGenerator {
	...
	protected String getRawValue() {
		...
		try {
			...
			sbValueBeforeMD5.append(":");
			sbValueBeforeMD5.append(Long.toString(randNum));
    ...
    public static void main(String[] args) {
    	GUIDGenerator generator = new GUIDGenerator(true);
