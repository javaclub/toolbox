 ...
 * @version $Id: AnnotationUtil.java 92 2011-07-09 16:24:52Z gerald.chen.hz@gmail.com $
 */
public abstract class AnnotationUtil {
	...
	/**
	 * Copy the properties of the supplied {@link Annotation} to the supplied
	 * target bean. Any properties defined in <code>excludedProperties</code>
	 * will not be copied.
	 * 
	 */
	public static void copyPropertiesToBean(Annotation ann, Object bean,
			String... excludedProperties) {
		AnnotationBeanUtils.copyPropertiesToBean(ann, bean, excludedProperties);
	}
