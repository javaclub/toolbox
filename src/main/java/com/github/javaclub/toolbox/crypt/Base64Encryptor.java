...
public class Base64Encryptor {
    ...
    public static String encodeToString(byte[] bytes) {
        ...
        return CodecUtil.toString(encoded);
    }
    ...
    public static String decodeToString(String base64Encoded) {
        byte[] encodedBytes = CodecUtil.toBytes(base64Encoded);
    ...
    public static String decodeToString(byte[] base64Encoded) {
        ...
        return CodecUtil.toString(decoded);
    }
    ...
    public static byte[] decode(String base64Encoded) {
        byte[] bytes = CodecUtil.toBytes(base64Encoded);
        return decode(bytes);
    }
