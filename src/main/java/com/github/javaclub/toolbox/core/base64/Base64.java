package com.github.javaclub.toolbox.core.base64;
...
public class Base64 {
	 ...
	 * 
	 * @param bytes The source sequence.
	 * @param wrapAt The max line length for encoded data. If less than 1 no
	 *            wrap is applied.
	 * @return The encoded sequence.
	 * @throws RuntimeException If an unexpected error occurs.
	 * @since 1.2
	...
	public static void main(String[] args) {
		String txt = "wwwzqjkxdqkkk831";
		String encoded = Base64.encode(txt);
		System.out.println(txt + "=" + encoded);
		System.out.println(txt.equals(Base64.decode(encoded)));
		
		String mm = "wgywhpurwgy";
		System.out.println(mm + "=" + Base64.encode(mm));
	}
}
